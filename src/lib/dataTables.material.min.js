(function (c) { "function" === typeof define && define.amd ? define(["jquery", "datatables"], function (a) { return c(a, window, document) }) : "object" === typeof exports ? module.exports = function (a, d) { a || (a = window); if (!d || !d.fn.dataTable) d = require("datatables")(a, d).$; return c(d, a, a.document) } : c(jQuery, window, document) })(function (c, a, d, r) {
